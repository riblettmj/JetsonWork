#!/bin/bash
# =============================================================================
# ENABLE JETSON CPU AND COOLING FAN CONFIGURATION SCRIPT:
...
#  Announce script
echo -e "\n\033[42m                                                                                \033[0m"
echo -e "\033[47;30m               ENABLE CPU AND COOLING FAN CONFIG :: M.J. Riblett                \033[0m"
echo -e "\033[42m                                                                                \033[0m"
echo -e "\n This script (re)enables the automatic the configuration of the CPU and fan"
